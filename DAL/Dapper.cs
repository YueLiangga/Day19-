...
namespace DAL
{
    ...
    {
        static string connection = "Data Source=.;Initial Catalog=Day19;Integrated Security=True";
        ...
        /// <returns></returns>
        public  IEnumerable<T> GetPageList<Tpage>(IDbConnection conn, string files, string tableName, string where, string orderby, int pageIndex, int pageSize, out int total)
        {
